## Contributing to Flow Brand

Thank you for your interest in contributing to **Flow Brand**!
We welcome all contributions — bug reports, feature proposals, documentation updates, and code improvements.
Your participation helps make the platform smarter, more reliable, and more impactful for brands.
...
```sh
git clone https://github.com/<your-username>/flowbrand-be.git
```
...
- Open an issue on the repository’s [GitHub Issues](https://github.com/hngprojects/flowbrand-be/issues) page.
...
Have an idea that would improve Flow Brand?

- Create a feature request on [GitHub Issues](https://github.com/hngprojects/flowbrand-be/issues).
...
Flow Brand follows the **Contributor Covenant Code of Conduct**.
